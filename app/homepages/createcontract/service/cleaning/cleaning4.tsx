...
interface CleaningPaymentSetupProps {
  onBack?: () => void;
  onNext?: (paymentData: PaymentSetup) => void;
}

const CleaningPaymentSetup: React.FC<CleaningPaymentSetupProps> = ({
  onBack,
  onNext,
}) => {
  const router = useRouter()
  const [paymentSetup, setPaymentSetup] = useState<PaymentSetup>({
    paymentType: 'invoice', // Default to invoice since it's the only option
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.mainContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <View style={styles.paymentDestinationCard}>
              ...
              <View style={styles.paymentDestinationText}>
                <Text style={styles.paymentDestinationName}>CLEANING SERVICES LLC</Text>
              </View>
        ...
        <View style={styles.completeButtonContainer}>
          <TouchableOpacity style={styles.completeButton} onPress={() => router.push('/homepages/createcontract/service/cleaning/cleaning5')}>
...
export default CleaningPaymentSetup;
