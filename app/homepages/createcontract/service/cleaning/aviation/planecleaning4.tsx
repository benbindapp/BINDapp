...
const CleaningPaymentSetup: React.FC<CleaningPaymentSetupProps> = ({
  ...
  const goBack = () => {
    console.log('Going back to cleaning protections...');
    onBack?.();
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.mainContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.completeButtonContainer}>
          <TouchableOpacity style={styles.completeButton} onPress={() => router.push('/homepages/createcontract/service/cleaning/aviation/planecleaning5')}>
