...
const PaymentDetails: React.FC<PaymentDetailsProps> = ({
  ...
  const getRemainingLabel = (): string => {
    ...
    return 'Remaining (Due Upon Completion):';
  };
      ...
      <ScrollView style={styles.mainContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <Text style={styles.sublabel}>Enter the total cost for the entire construction project</Text>
          ...
          <View style={styles.fieldContainer}>
            ...
            {formData.paymentType === 'upfront' && (
              <View style={styles.depositAmountSection}>
                <Text style={styles.sublabel}>Enter material deposit amount</Text>
                <View style={styles.currencyInputContainer}>
                  <Text style={styles.currencySymbol}>$</Text>
                  <TextInput
                ...
                {showPaymentBreakdown && (
                  <View style={styles.paymentBreakdown}>
                    ...
                    <View style={styles.breakdownItem}>
                      <Text style={styles.breakdownLabel}>Material Deposit (Due Now):</Text>
                    ...
                    <View style={styles.breakdownTotal}>
                      <Text style={styles.breakdownTotalLabel}>Total Project Cost:</Text>
          ...
          <View style={styles.fieldContainer}>
            ...
            <View style={styles.paymentDestinationCard}>
              ...
              <View style={styles.paymentDestinationText}>
                <Text style={styles.paymentDestinationName}>CONSTRUCTION SERVICES LLC</Text>
              </View>
        ...
        <View style={styles.completeButtonContainer}>
          <TouchableOpacity 
            ...
            onPress={() => router.push('/homepages/createcontract/service/construction/construction5')}
            activeOpacity={0.8}
          >
