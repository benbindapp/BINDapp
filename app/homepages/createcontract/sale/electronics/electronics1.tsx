...
const ElectronicsDetails: React.FC<ElectronicsDetailsProps> = ({
  onBack,
  onNext,
  onAddPhotos,
}) => {
  ...
  const shouldShowStorage = () => {
    return ['Smartphone', 'Tablet', 'Laptop', 'Desktop Computer'].includes(formData.category);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.mainContent} showsVerticalScrollIndicator={false}>
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Electronics Details</Text>
          <Text style={styles.subtitle}>Fill in the details of the electronics being sold</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              style={styles.input}
              placeholder="Apple, Samsung, Sony, etc."
          ...
          {/* Storage (conditional field for relevant electronics) */}
          {shouldShowStorage() && (
            <View style={styles.fieldContainer}>
              <Text style={styles.label}>Storage/Memory</Text>
              <TextInput
                style={styles.input}
                placeholder="64GB, 256GB, 1TB, etc."
                placeholderTextColor="#9CA3AF"
          ...
          <View style={styles.fieldContainer}>
            ...
            <View style={styles.photoSection}>
              <Text style={styles.photoLimitText}>Add up to 5 photos of your electronics</Text>
              <TouchableOpacity
        ...
        <View style={styles.nextButtonContainer}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/homepages/createcontract/sale/electronics/electronics2')}
            activeOpacity={0.8}
          >
